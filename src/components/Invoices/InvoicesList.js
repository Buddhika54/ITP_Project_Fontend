...
export default function InvoicesList() {
  ...
  return (
    <div className="container mx-auto mt-6 p-10 overflow-x-auto bg-white rounded-lg shadow-md bg-white/80 backdrop-blur-md">
              ...
              {invoices.length > 0 ? (
                invoices.map((inv) => (
                  <tr key={inv._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2 border-b">
                      <a
                        href={`${API_URL}/api/order/${encodeURIComponent(inv.orderId?._id || inv.orderId)}/invoice`}
                        target="_blank"
